...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden min-h-screen flex flex-col justify-center bg-linear-to-b from-white to-pink-50">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-2">
            ...
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-2xl py-8">
              ...
              cancer ainsi que des personnes diabétiques et des aidants. Ce
              périple s&apos;accompagne d&apos;une cagnotte dont les fonds
              seront reversés à la recherche pour ces deux maladies.
            </p>
            <div className="flex flex-wrap gap-4">
              ...
              >
                <Button
                  size="lg"
                  variant="default"
                  className="rounded-full font-semibold px-8 bg-linear-to-r from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700 text-white shadow-lg transition-all cursor-pointer"
                >
